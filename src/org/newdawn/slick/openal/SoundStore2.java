...
public class SoundStore2 {
	...
	private static SoundStore2 store = new SoundStore2();
	...
	public Audio getAIF(String ref, InputStream in) throws IOException {
		...
		return new AudioImpl2(this, buffer);
	}
